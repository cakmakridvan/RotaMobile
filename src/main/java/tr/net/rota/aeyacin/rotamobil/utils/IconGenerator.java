...
public class IconGenerator {
    ...
    public IconGenerator(Context context) {
        ...
        mTextView = (TextView) mRotationLayout.findViewById(R.id.amu_text);
        mIcon=(ImageView)mRotationLayout.findViewById(R.id.amu_text);
        mContentView =mRotationLayout;
     ...
     * #setTextAppearance} and  will operate upon that {@link TextView}.
     */
